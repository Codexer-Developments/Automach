                        ...
                        <div class="image-wcs relative">
                            <ul class="icon-list">
                                <li class="tf-icon-list ani5">
                                    ...
                                    <span class="fs-18 fw-6 lh-25 text-color-2">Trusted by Thousands</span>
                                </li>
                                <li class="tf-icon-list ani4">
                                    <i class="icon-autodeal-check"></i>
                                    <span class="fs-18 fw-6 lh-25 text-color-2">Global Reach, Local Expertise</span>
                                </li>
                                <li class="tf-icon-list ani5">
                                    <i class="icon-autodeal-check"></i>
                                    <span class="fs-18 fw-6 lh-25 text-color-2">Expanding Opportunities</span>
                                </li>
                            </ul>
                            <div class="image-inner1 hover-img-wrap img-style-hover">
                                <img class=" ls-is-cached lazyloaded" data-src="{{ asset('frontend/assets/images/section/wcu-1.jpg') }}"
                                    src="{{ asset('frontend/assets/images/section/wcu-1.jpg') }}" alt="images">
                            </div>
                            <div class="image-inner2">
                                <img class=" ls-is-cached lazyloaded" data-src="{{ asset('frontend/assets/images/section/wcu-2.png') }}"
                                    src="{{ asset('frontend/assets/images/section/wcu-2.png') }}" alt="images">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="content-wcs">
                            <div class="heading-section">
                                <h2>Why Choose Automach?
                                </h2>
                                <p class="mt-18">Automach is more than just a marketplace for cars—it's a trusted partner in your journey of buying or selling vehicles. Built on innovation and customer satisfaction, Automach bridges the gap between car enthusiasts and quality sellers. Here's why Automach stands out:
                            ...
                            <div class="tf-icon-box-list">
                                <div class="tf-icon-box style-2">
                                    ...
                                    <div class="content">
                                        <h5><a href="#">Expertise You Can Trust

                                        </a></h5>
                                        <p>With a dedicated team that lives and breathes the automotive world, Automach brings years of experience to ensure smooth, informed, and successful transactions.</p>
                                    </div>
                                </div>
                                <div class="tf-icon-box style-2">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <h5><a href="#">A Thriving Hub of Activity</a></h5>
                                        <p>Every day, thousands of car enthusiasts visit Automach to explore, compare, and connect. Our platform thrives on dynamic interactions and an ever-growing community.</p>
                                    </div>
                                </div>
                                <div class="tf-icon-box style-2">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <h5><a href="#">Diverse Seller Network
                                        </a></h5>
                                        <p>Whether it’s individuals selling their personal vehicles or dealerships showcasing their fleet, Automach offers a wide range of options, ensuring that you’ll always find what you’re looking for.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
