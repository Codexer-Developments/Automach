        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="heading-section">
                    ...
                    <p class="mt-18">There Are Currently {{ $cars->count() }} Results</p>
                </div>
            </div>
            <div class="col-lg-12">
                    ...
                    @foreach ($cars as $car)
                        <div class="box-car-list hv-one">
                            ...
                            <div class="content">
                                ...
                                <div class="money fs-20 fw-5 lh-25 text-color-3">£{{ number_format($car->price) }}
                                </div>
                                <div class="days-box flex justify-space align-center">
                                    <div class="img-author">
                                        <img class="lazyload"
                                            src="https://ui-avatars.com/api/?name={{ $car->user?->name }}"
                                            alt="{{ $car->user?->name }}">
                ...
                <div class="themesflat-pagination pagination-style1 clearfix center">
                    <ul>
                        ...
                        @else
                            <li><a href="{{ $cars->previousPageUrl() }}" class="page-numbers style"><i
                        ...
                        @foreach ($cars->links()->elements as $element)
                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    ...
                                    @else
                                        <li><a href="{{ $url }}" class="page-numbers">{{ $page }}</a>
                                        </li>
                                    @endif
                                @endforeach
                            @endif
                        ...
                        @if ($cars->hasMorePages())
                            <li><a href="{{ $cars->nextPageUrl() }}" class="page-numbers style"><i
