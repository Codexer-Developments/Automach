...
@section('single_page_name', $car->name)
                                ...
                                @foreach ($car->image_urls as $image)
                                    <div class="swiper-slide">
                                        <div class="image-list-details">
                                            <img class="lazyload swiper-image"
                                                src="{{ asset('storage/' . $image['url']) }}" alt="{{ $car->name }}">
                                        </div>
                                    </div>
                                @endforeach
                            @else
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">
                                                            Condition:</span>
                                                        <p class="listing-info-value">{{ $car->condition }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value">{{ $car->cylinders }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Fuel
                                                            Type:</span>
                                                        <p class="listing-info-value">{{ $car->fuel_type }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">
                                                            Year:</span>
                                                        <p class="listing-info-value">{{ $car->year }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value">{{ $car->seats }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value">{{ $car->transmission }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                ...
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Engine
                                                            Size:</span>
                                                        <p class="listing-info-value">{{ $car->engine_size }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Highway
                                                            MPG:</span>
                                                        <p class="listing-info-value">{{ $car->highway_mpg }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Drive
                                                            Type:</span>
                                                        <p class="listing-info-value">{{ $car->drive_type }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="listing-calculator loan-calculator-form" id="scrollspyHeading4">
                                    ...
                                    <div id="comments" class="comments">
                                        <div class="respond-comment">
                                            <form id="inquiryForm" class="comment-form form-submit"
                                                ...
                                                <fieldset class="name-wrap">
                                                    ...
                                                    <textarea name="message" id="" class="form-control" rows="5" class="tb-my-input" required></textarea>
                                                    {{-- <input type="text" name="name" id="name" class="tb-my-input" required> --}}
                                                </fieldset>
                ...
                <div class="listing-sidebar">
                    <div class="widget-listing mb-40">
                        <div class="heading-widget">
                            ...
                            <div class="money text-color-3 font">£{{ number_format($car->price) }}</div>
                            <div class="price-wrap">
                                <p class="fs-12 lh-16 text-color-2">Monthly installment payment: <span
                                        class="fs-14 fw-5 font">N/A</span></p>
                                <p class="fs-12 lh-16">New car price: N/A</p>
                            </div>
                    ...
                    <div class="widget-listing mb-30">
                        ...
                        <div class="profile-map mb-30">
                            <div class="list-icon-pf gap-8 flex-three ">
                                ...
                                <p class="font-1">81 Brakens Lane Alvaston Derby DE22 0AQ</p>
                            </div>
                            <div class="map">
                                <iframe class="map-content"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2407.249798963331!2d-1.4412208000000002!3d52.8899252!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4879f05c5142afb1%3A0x8e5906ea3cfa2342!2s81%20Bracken&#39;s%20Ln%2C%20Alvaston%2C%20Derby%20DE24%200AQ!5e0!3m2!1sen!2suk!4v1737570831998!5m2!1sen!2suk"
